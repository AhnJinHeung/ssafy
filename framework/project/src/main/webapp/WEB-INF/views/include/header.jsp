...
<script>
		...
		$.ajax({
			...
			success : function(data) { //DB접근 후 가져온 데이터
				$.each(data, function(index, item) {
					$('#sido').append("<option value = " + item.sido + ">" + item.sido + "</option>");
				});
			}
		})
	...
	function join() {
		if (document.getElementById("uid").value == "") {
			...
			document.getElementById("registerform").action = "${root}/member/join";
	...
	function searchApt() {
		if ($("#dong option:selected").val() == "동") {
			...
			document.getElementById("frm").action = "${root}/house/findApt";
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="loginform" method="post" action="">
						...
						<a style="color : black;" href="findUser.jsp"><i class="fa fa-key" aria-hidden="true"></i>비밀번호를 잊으셨나요?</a>
					</form>
				</div>
