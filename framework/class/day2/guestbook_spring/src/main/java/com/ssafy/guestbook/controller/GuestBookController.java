...
@Controller
@RequestMapping("/article") // 무조건 /article로 들어오면 이쪽으로 들어옴
...
//	@RequestMapping(value = "/write", method = RequestMethod.GET)
	@GetMapping("/write")
	public String write() {  //로그인 한사람만 오게 처리를 여기 오기전에 이미 하고 옴.(interceptor 패키지확인_)
...
//		    System.out.println("로그인 했다면....!!!"); 이랑 거의 같지만 위에 꺼로 찍으면 더 자세하게 나옴.
